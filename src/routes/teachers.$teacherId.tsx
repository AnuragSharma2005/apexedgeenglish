        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              ...
              <div className="bg-white rounded-2xl p-4 text-center shadow-sm border border-black/5">
                <LucideAward className="w-5 h-5 text-[#2d7f72] mx-auto mb-1.5" />
                <p className="text-lg font-black text-[#1a1a1a]">{teacher.achievements.length}+</p>
                <p className="text-xs text-gray-400 font-semibold uppercase tracking-wider mt-0.5">Awards</p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mt-10">
                ...
                <div className="bg-white rounded-2xl p-5 text-center shadow-sm border border-black/5 hover:shadow-md transition-shadow">
                  <LucideAward className="w-6 h-6 text-[#2d7f72] mx-auto mb-2" />
                  <p className="text-xl font-black text-[#1a1a1a]">{teacher.achievements.length}+</p>
                  <p className="text-xs text-gray-400 font-semibold uppercase tracking-wider mt-1">Awards</p>
                </div>
              </div>
